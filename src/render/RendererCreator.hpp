...
public:
    ...
    virtual std::unique_ptr<Renderer> createRenderer(const std::unordered_set<std::string> &requiredSpriteNames,
                                                     SceneType sceneType) const = 0;
};
...
public:
    ...
    std::unique_ptr<Renderer> createRenderer(const std::unordered_set<std::string> &requiredSpriteNames,
